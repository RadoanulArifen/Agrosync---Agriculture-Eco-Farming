  ...
  return (
    <DashboardShell navItems={VENDOR_NAV_ITEMS} role="vendor" userName={user.companyName || user.name} userSubtitle={user.designation || 'Verified Vendor'} notificationCount={notificationCount}>
      ...
      <RoleProfileEditor
        ...
        onCancelEdit={resetVendorDetails}
            ...
            <div className="space-y-4 p-5">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <label className="block">
                  ...
                  <input className="input-field mt-2 disabled:bg-white disabled:text-gray-500" disabled={!editable} value={shopName} onChange={(e) => setShopName(e.target.value)} />
                </label>
                <label className="block">
                ...
                <label className="block md:col-span-2">
                  ...
                  <input className="input-field mt-2 disabled:bg-white disabled:text-gray-500" disabled={!editable} value={deliveryDistricts} onChange={(e) => setDeliveryDistricts(e.target.value)} />
                </label>
              </div>
            </div>
          </Card>
